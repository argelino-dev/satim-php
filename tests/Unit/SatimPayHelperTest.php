...
it('throws exception when statusOrderResponse is empty', function (): void {
...
it('throws exception when confirmOrderResponse is empty', function (): void {
...
it('throws exception when calling getResponse() without setting context', function (): void {
    $this->helper->getResponse();
})->throws(SatimMissingDataException::class, 'No response data found. Call one of the methods first to obtain the response data.');

it('throws exception when calling getResponse() without register data', function (): void {
...
it('retrieves register order response correctly', function (): void {
    $this->helper->setContext('register');
...
it('retrieves confirm order response correctly', function (): void {
...
it('retrieves order ID from response', function (): void {
    $this->helper->setContext('register');
...
it('retrieves IP address from response', function (): void {
    $this->helper->setContext('register');
...
it('returns null if IP address is missing', function (): void {
...
it('retrieves cardholder name from response', function (): void {
    $this->helper->setContext('register');
...
it('retrieves card expiry date from response', function (): void {
    $this->helper->setContext('register');
...
it('retrieves card PAN from response', function (): void {
    $this->helper->setContext('register');
...
it('retrieves approval code from response', function (): void {
    $this->helper->setContext('register');
...
it('retrieves payment form URL from response', function (): void {
    $this->helper->setContext('register');
...
it('throws exception when payment form URL is missing', function (): void {
    $this->helper->setContext('register'); // Ensure context is set
...
it('throws exception when calling getResponse() with an invalid context', function (): void {
    $this->helper->setContext('invalid');
    $this->helper->getResponse();
})->throws(SatimMissingDataException::class, 'No response data found. Call one of the methods first to obtain the response data.');

it('retrieves status order response correctly', function (): void {
...
it('retrieves refund order response correctly', function (): void {
...
it('throws exception when calling getResponse() without refund data', function (): void {
    $this->helper->setContext('refund');
    $this->helper->getResponse();
