 ...
 */
it('returns correct API URL', function () {
 ...
 */
it('throws exception when API response contains error code 6 (Unknown Order ID)', function () {
 ...
 */
it('throws exception when network error occurs', function () {
 ...
 */
it('throws SatimUnexpectedResponseException for ClientException', function () {
 ...
 */
it('throws SatimUnexpectedResponseException for RedirectionException', function () {
 ...
 */
it('throws SatimUnexpectedResponseException for ServerException', function () {
 ...
 */
it('throws SatimInvalidCredentials for ErrorCode 5 with Access Denied message', function () {
 ...
 */
it('throws SatimUnexpectedResponseException for ErrorCode 5 with missing message', function () {
 ...
 */
it('throws SatimUnexpectedResponseException for unknown ErrorCode', function () {
